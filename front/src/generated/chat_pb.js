 ...
 * @return {string}
 */
proto.chat.MessageRequest.prototype.getUser = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};
 ...
 */
proto.chat.MessageRequest.prototype.setUser = function(value) {
  return jspb.Message.setProto3StringField(this, 1, value);
};
...
exports.MessageRequest = proto.chat.MessageRequest;
exports.Empty = proto.chat.Empty;